...
/// The official GitHub mark (Simple Icons "github", MIT-licensed) — inlined
/// so the footer link icon is instantly recognizable instead of a generic
/// `Icons.code` glyph that could mean anything.
